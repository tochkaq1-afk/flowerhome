...
const CATEGORIES = [
  {
    ...
    cover: 'images/products/nezhnoe-priznanie.webp',
    subs: [
  ...
  },
  {
    ...
    cover: 'images/products/anturium.webp',
    subs: [
  ...
  },
  {
    ...
    cover: 'images/products/svecha-steklo-100.webp',
    subs: [
  ...
  },
  {
    ...
    cover: 'images/products/svecha-tyulpany.webp',
    subs: [
  ...
  },
  {
    ...
    cover: 'images/products/mishka-s-bantikom-2.webp',
    subs: [
...
const PRODUCTS = [
  /* ---------- БУКЕТЫ ---------- */
  { id:'legkoe-obyatie', name:'Букет «Лёгкое объятие»', price:125, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/legkoe-obyatie.webp', stock:true, hit:true,
    note:'Мягкий, обволакивающий букет пастельных оттенков — тот случай, когда цветы говорят тише слов.' },
  { id:'nezhnoe-priznanie', name:'Букет «Нежное признание»', price:449, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/nezhnoe-priznanie.webp', stock:true, hit:true,
    note:'Большой авторский букет для самого важного разговора. Собираем в день доставки.' },
  { id:'rozovyy-rumyanec', name:'Букет «Розовый румянец»', price:113, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/rozovyy-rumyanec.webp', stock:true, hit:true,
    note:'Тёплая розовая гамма с живой зеленью — лёгкий и очень «весенний» по настроению.' },
  { id:'shepot-lyubvi', name:'Букет «Шёпот любви»', price:123, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/shepot-lyubvi.webp', stock:true,
    note:'Сдержанный и романтичный — без пафоса, но с характером.' },
  { id:'morskaya-laguna', name:'Букет «Морская лагуна»', price:179, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/morskaya-laguna.webp', stock:true, hit:true,
    note:'Прохладные голубые и белые тона. Смотрится свежо даже в самый жаркий день.' },
  { id:'persikovoe-nebo', name:'Букет «Персиковое небо»', price:101, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/persikovoe-nebo.webp', stock:true,
    note:'Персиковая палитра, мягкий свет — букет, который хочется поставить на кухонный стол.' },
  { id:'pionovidnaya-simfoniya', name:'Букет «Пионовидная симфония»', price:153, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/pionovidnaya-simfoniya.webp', stock:true, hit:true,
    note:'Пышные пионовидные розы крупным планом. Один из самых заказываемых букетов.' },
  { id:'znak-vnimaniya', name:'Букет «Знак внимания»', price:69, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/znak-vnimaniya.webp', stock:true,
    note:'Компактный букет без повода. Часто берут «просто так» — и это лучший повод.' },
  { id:'solnechnaya-dolina', name:'Букет «Солнечная долина»', price:81, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/solnechnaya-dolina.webp', stock:false,
    note:'Тёплые солнечные оттенки. Сейчас закончился — напишите, соберём похожий.' },
  { id:'aromatnyy-vzryv', name:'Букет «Ароматный взрыв»', price:101, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/aromatnyy-vzryv.webp', stock:true,
    note:'Собран вокруг душистых сортов — его слышно раньше, чем видно.' },
  { id:'beloe-oblako', name:'Букет «Белое облако»', price:83, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/beloe-oblako.webp', stock:true,
    note:'Воздушный белый монобукет. Универсальный и всегда уместный.' },
  { id:'vostorg-lyubvi', name:'Букет «Восторг любви»', price:137, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/vostorg-lyubvi.webp', stock:true,
    note:'Насыщенный, яркий, с характером — для эмоционального момента.' },
  { id:'garmoniya', name:'Букет «Гармония»', price:99, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/garmoniya.webp', stock:true,
    note:'Сбалансированная композиция, где ни один цвет не перетягивает внимание.' },
  { id:'gracioznaya-krasota', name:'Букет «Грациозная красота»', price:239, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/gracioznaya-krasota.webp', stock:true,
    note:'Крупный праздничный букет с выразительным силуэтом.' },
  { id:'kompliment', name:'Букет «Комплимент»', price:79, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/kompliment.webp', stock:true,
    note:'Небольшой, но продуманный. Отличный вариант «занести по дороге».' },
  { id:'magicheskaya-krasota', name:'Букет «Магическая красота»', price:101, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/magicheskaya-krasota.webp', stock:true,
    note:'Глубокие оттенки и плотная фактура — выглядит дороже, чем стоит.' },
  { id:'magiya-sovershenstva', name:'Букет «Магия совершенства»', price:85, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/magiya-sovershenstva.webp', stock:true,
    note:'Аккуратная круглая форма, чистая палитра, ничего лишнего.' },
  { id:'morskaya-volna', name:'Букет «Морская волна»', price:97, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/morskaya-volna.webp', stock:true,
    note:'Сине-белая гамма с прохладной зеленью.' },
  { id:'rozovoe-schaste', name:'Букет «Розовое счастье»', price:109, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/rozovoe-schaste.webp', stock:true,
    note:'Розовый во всех его оттенках — от почти белого до глубокого малинового.' },
  { id:'bal-cvetov', name:'Букет «Бал цветов»', price:251, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/bal-cvetov.webp', stock:true, hit:true,
    note:'Многосоставный букет-событие. Берут на юбилеи и большие даты.' },
  { id:'beskonechnost', name:'Букет «Бесконечность»', price:101, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/beskonechnost.webp', stock:true,
    note:'Спокойный, с длинной линией стеблей — красиво стоит в высокой вазе.' },
  { id:'vesenniy-mig', name:'Букет «Весенний миг»', price:127, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/vesenniy-mig.webp', stock:true,
    note:'Светлый весенний набор — хорошо заходит к 8 марта и на день рождения.' },
  { id:'gimn-vesne', name:'Букет «Гимн весне»', price:235, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/gimn-vesne.webp', stock:true,
    note:'Крупный весенний букет с богатой палитрой.' },
  { id:'zolotoe-serdce', name:'Букет «Золотое сердце»', price:289, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/zolotoe-serdce.webp', stock:true,
    note:'Тёплые золотистые тона, плотная сборка. Подарок с весом.' },
  { id:'lilovye-pocelui', name:'Букет «Лиловые поцелуи»', price:133, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/lilovye-pocelui.webp', stock:true,
    note:'Лиловая гамма — редкая и запоминающаяся.' },
  { id:'malaya-vselennaya', name:'Букет «Малая вселенная»', price:87, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/malaya-vselennaya.webp', stock:true,
    note:'Небольшой, но насыщенный деталями — интересно разглядывать вблизи.' },
  { id:'malinovyy-muss', name:'Букет «Малиновый мусс»', price:87, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/malinovyy-muss.webp', stock:true,
    note:'Сочный малиновый акцент на светлой основе.' },
  { id:'neumolimoe-vlechenie', name:'Букет «Неумолимое влечение»', price:111, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/neumolimoe-vlechenie.webp', stock:true,
    note:'Тёмная драматичная палитра для тех, кто не любит пастель.' },
  { id:'poyas-venery', name:'Букет «Пояс Венеры»', price:215, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/poyas-venery.webp', stock:true,
    note:'Крупный, с плавным переходом оттенков по всему объёму.' },
  { id:'purpurnye-grezy', name:'Букет «Пурпурные грёзы»', price:79, cat:'cvety', sub:'bukety', occ:'vnimanie', img:'images/products/purpurnye-grezy.webp', stock:true,
    note:'Пурпур и зелень. Компактно и выразительно.' },
  { id:'radost-vstrechi', name:'Букет «Радость встречи»', price:357, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/radost-vstrechi.webp', stock:true, hit:true,
    note:'Большой встречающий букет — для аэропорта, вокзала и важных возвращений.' },
  { id:'rozovaya-simfoniya', name:'Букет «Розовая симфония»', price:330, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/rozovaya-simfoniya.webp', stock:true,
    note:'Крупная работа в розовой гамме. Собираем под заказ.' },
  { id:'romantichnaya-nezhnost', name:'Букет «Романтичная нежность»', price:165, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/romantichnaya-nezhnost.webp', stock:true,
    note:'Классическая романтика без клише.' },
  { id:'svidanie-v-parizhe', name:'Букет «Свидание в Париже»', price:103, cat:'cvety', sub:'bukety', occ:'romantika', img:'images/products/svidanie-v-parizhe.webp', stock:true,
    note:'Французская сдержанность: приглушённые тона, свободная сборка.' },
  { id:'solnechnyy-zakat', name:'Букет «Солнечный закат»', price:135, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/solnechnyy-zakat.webp', stock:true,
    note:'Тёплый градиент от жёлтого к терракоте.' },
  { id:'stilnyy-miks', name:'Букет «Стильный микс»', price:151, cat:'cvety', sub:'bukety', occ:'prazdnik', img:'images/products/stilnyy-miks.webp', stock:true,
    note:'Смелое сочетание фактур — для тех, кто просит «что-нибудь необычное».' },

  /* ---------- КОМПОЗИЦИИ ---------- */
  { id:'k-rozovaya-akvarel', name:'Композиция «Розовая акварель»', price:71, cat:'cvety', sub:'kompozicii', occ:'vnimanie', img:'images/products/k-rozovaya-akvarel.webp', stock:true,
    note:'В шляпной коробке с флористической губкой — воду доливать раз в пару дней.' },
  { id:'k-snezhnoe-obloko', name:'Композиция «Снежное облако»', price:63, cat:'cvety', sub:'kompozicii', occ:'vnimanie', img:'images/products/k-snezhnoe-obloko.webp', stock:true,
    note:'Белоснежная композиция в коробке. Не требует вазы.' },
  { id:'k-cvetochnaya-polyana', name:'Композиция «Цветочная поляна»', price:359, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-cvetochnaya-polyana.webp', stock:true, hit:true,
    note:'Большая интерьерная композиция — работает как арт-объект в комнате.' },
  { id:'k-vsplesk-emociy', name:'Композиция «Всплеск эмоций»', price:590, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-vsplesk-emociy.webp', stock:true,
    note:'Премиальная работа под заказ. Согласовываем палитру заранее.' },
  { id:'k-goluboe-oblako', name:'Композиция «Голубое облако»', price:51, cat:'cvety', sub:'kompozicii', occ:'vnimanie', img:'images/products/k-goluboe-oblako.webp', stock:true,
    note:'Небольшая композиция в прохладной гамме.' },
  { id:'k-parizhskiy-shik', name:'Композиция «Парижский шик»', price:310, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-parizhskiy-shik.webp', stock:true,
    note:'Крупная композиция в сдержанной европейской палитре.' },
  { id:'k-prityazhenie', name:'Композиция «Притяжение»', price:290, cat:'cvety', sub:'kompozicii', occ:'romantika', img:'images/products/k-prityazhenie.webp', stock:true,
    note:'Плотная, объёмная работа с выразительным центром.' },
  { id:'k-radost-vstrechi', name:'Композиция «Радость встречи»', price:61, cat:'cvety', sub:'kompozicii', occ:'vnimanie', img:'images/products/k-radost-vstrechi.webp', stock:true,
    note:'Компактная композиция в коробке — удобно везти и вручать.' },
  { id:'k-arhitektura-krasoty', name:'Композиция «Архитектура красоты»', price:159, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-arhitektura-krasoty.webp', stock:true,
    note:'Геометричная сборка с чистыми линиями.' },
  { id:'k-zhazhda-stranstviy', name:'Композиция «Жажда странствий»', price:89, cat:'cvety', sub:'kompozicii', occ:'dom', img:'images/products/k-zhazhda-stranstviy.webp', stock:true,
    note:'Композиция с сухоцветами и живой зеленью — стоит долго.' },
  { id:'k-kompliment', name:'Композиция «Комплимент»', price:61, cat:'cvety', sub:'kompozicii', occ:'vnimanie', img:'images/products/k-kompliment.webp', stock:true,
    note:'Маленькая композиция как дополнение к основному подарку.' },
  { id:'k-nezhnost', name:'Композиция «Нежность»', price:97, cat:'cvety', sub:'kompozicii', occ:'romantika', img:'images/products/k-nezhnost.webp', stock:true,
    note:'Пастельная композиция средних размеров.' },
  { id:'k-ogni-teatra', name:'Композиция «Огни театра»', price:93, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-ogni-teatra.webp', stock:true,
    note:'Контрастная и нарядная — хорошо смотрится при вечернем свете.' },
  { id:'k-eyforiya', name:'Композиция «Эйфория»', price:605, cat:'cvety', sub:'kompozicii', occ:'prazdnik', img:'images/products/k-eyforiya.webp', stock:true,
    note:'Самая крупная композиция в каталоге. Только по предзаказу.' },

  /* ---------- СУХОЦВЕТЫ ---------- */
  { id:'kraspediya', name:'Краспедия', price:3.5, cat:'cvety', sub:'suhocvety', occ:'dom', img:'images/products/kraspediya.webp', stock:true,
    note:'Жёлтые шарики на длинном стебле. Цена за штуку.' },
  { id:'oves', name:'Овёс', price:0.8, cat:'cvety', sub:'suhocvety', occ:'dom', img:'images/products/oves.webp', stock:true,
    note:'Лёгкий природный акцент для букета. Цена за штуку.' },
  { id:'pampasnaya-trava', name:'Пампасная трава', price:4, cat:'cvety', sub:'suhocvety', occ:'dom', img:'images/products/pampasnaya-trava.webp', stock:true,
    note:'Пушистые метёлки для интерьерных композиций. Цена за штуку.' },
  { id:'stifa', name:'Стифа', price:15, cat:'cvety', sub:'suhocvety', occ:'dom', img:'images/products/stifa.webp', stock:true,
    note:'Тонкая структурная трава. Не требует ухода и не осыпается.' },

  /* ---------- ЦВЕТУЩИЕ РАСТЕНИЯ ---------- */
  { id:'azaliya', name:'Азалия', price:41, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/azaliya.webp', stock:true,
    note:'Обильно цветёт зимой и весной. Любит прохладу и регулярный полив.' },
  { id:'kalanhoe', name:'Каланхоэ «Каландива»', price:25, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/kalanhoe.webp', stock:true,
    note:'Неприхотливое растение с плотными соцветиями. Хорошо для начинающих.' },
  { id:'kallistemon', name:'Каллистемон', price:229, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/kallistemon.webp', stock:true,
    note:'Эффектное растение с соцветиями-щётками. Нужен яркий свет.' },
  { id:'oleandr', name:'Олеандр', price:71, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/oleandr.webp', stock:true,
    note:'Южное растение с длительным цветением. Любит солнце.' },
  { id:'spatifillum', name:'Спатифиллум', price:23, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/spatifillum.webp', stock:true, hit:true,
    note:'«Женское счастье» — теневынослив, прощает нерегулярный полив.' },
  { id:'ciklamen', name:'Цикламен', price:41, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/ciklamen.webp', stock:true,
    note:'Цветёт в холодный сезон. Полив через поддон.' },
  { id:'anturium', name:'Антуриум', price:79, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/anturium.webp', stock:true, hit:true,
    note:'Глянцевые прицветники держатся неделями. Одно из самых фотогеничных растений.' },
  { id:'spatifillum-bolshoy', name:'Спатифиллум крупный', price:69, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/spatifillum-bolshoy.webp', stock:true,
    note:'Взрослый экземпляр в большом горшке — сразу заполняет угол комнаты.' },
  { id:'stefanotis', name:'Стефанотис', price:79, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/stefanotis.webp', stock:true,
    note:'Вьющееся растение с ароматными белыми цветками.' },
  { id:'strelitsiya', name:'Стрелиция', price:53, cat:'rasteniya', sub:'cvetushchie', occ:'dom', img:'images/products/strelitsiya.webp', stock:true,
    note:'«Райская птица». Крупные листья, экзотический силуэт.' },

  /* ---------- СВЕЧИ ---------- */
  { id:'svecha-tyulpany', name:'Свеча «Букет тюльпанов»', price:25, cat:'dekor', sub:'svechi', occ:'dom', img:'images/products/svecha-tyulpany.webp', stock:true, hit:true,
    note:'Фигурная свеча ручной работы. Красиво стоит даже незажжённой.' },
  { id:'svecha-steklo-100', name:'Свеча в стекле, 100 мл', price:33, cat:'dekor', sub:'svechi', occ:'dom', img:'images/products/svecha-steklo-100.webp', stock:true,
    note:'Ароматическая свеча в стеклянном стакане. Горит около 20 часов.' },
  { id:'svecha-steklo-50', name:'Свеча в стекле, 50 мл', price:19, cat:'dekor', sub:'svechi', occ:'dom', img:'images/products/svecha-steklo-50.webp', stock:true,
    note:'Компактный формат — удобно добавлять к букету.' },
  { id:'svecha-mishka', name:'Свеча «Мишка»', price:19, cat:'dekor', sub:'svechi', occ:'vnimanie', img:'images/products/svecha-mishka.webp', stock:true,
    note:'Фигурная свеча-медвежонок.' },
  { id:'svecha-mishka-bant', name:'Свеча «Мишка с бантом»', price:19, cat:'dekor', sub:'svechi', occ:'vnimanie', img:'images/products/svecha-mishka-bant.webp', stock:true,
    note:'Тот же мишка, но нарядный.' },
  { id:'svecha-mishka-teddi', name:'Свеча «Мишка Тедди»', price:19, cat:'dekor', sub:'svechi', occ:'vnimanie', img:'images/products/svecha-mishka-teddi.webp', stock:true,
    note:'Классический тедди в виде свечи.' },
  { id:'svecha-sova', name:'Свеча «Сова»', price:23, cat:'dekor', sub:'svechi', occ:'dom', img:'images/products/svecha-sova.webp', stock:true,
    note:'Детализированная фигурная свеча.' },
  { id:'svecha-tors', name:'Свеча «Торс»', price:19, cat:'dekor', sub:'svechi', occ:'dom', img:'images/products/svecha-tors.webp', stock:true,
    note:'Скульптурная свеча в античном духе — популярный интерьерный объект.' },

  /* ---------- МЯГКИЕ ИГРУШКИ ---------- */
  { id:'zayac', name:'Заяц', price:61, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/zayac.webp', stock:true,
    note:'Большой мягкий заяц. Хорошо дополняет крупный букет.' },
  { id:'brelok-akula', name:'Игрушка-брелок «Акула»', price:13, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/brelok-akula.webp', stock:true,
    note:'Маленький брелок — приятная мелочь к заказу.' },
  { id:'brelok-zayac', name:'Игрушка-брелок «Заяц»', price:13, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/brelok-zayac.webp', stock:true,
    note:'Мягкий брелок на сумку или рюкзак.' },
  { id:'brelok-utochka', name:'Игрушка-брелок «Уточка»', price:13, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/brelok-utochka.webp', stock:true,
    note:'Небольшой брелок-уточка.' },
  { id:'transformer-zayac', name:'Игрушка-трансформер «Заяц»', price:23, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/transformer-zayac.webp', stock:true,
    note:'Выворачивается наизнанку и меняет выражение.' },
  { id:'transformer-zayac-2', name:'Игрушка-трансформер «Заяц», вариант 2', price:23, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/transformer-zayac-2.webp', stock:true,
    note:'Другая расцветка того же трансформера.' },
  { id:'transformer-stich', name:'Игрушка-трансформер «Стич»', price:23, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/transformer-stich.webp', stock:true,
    note:'Популярный герой в формате трансформера.' },
  { id:'kot-murzik', name:'Кот «Мурзик»', price:19, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/kot-murzik.webp', stock:true,
    note:'Небольшой мягкий кот.' },
  { id:'mishka-v-bayke', name:'Мишка в байке', price:32, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/mishka-v-bayke.webp', stock:true,
    note:'Медведь в толстовке — самый ходовой размер.' },
  { id:'mishka-s-bantikom', name:'Мишка с бантиком', price:33, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/mishka-s-bantikom.webp', stock:true,
    note:'Классический плюшевый медведь.' },
  { id:'mishka-s-bantikom-2', name:'Мишка с бантиком, большой', price:47, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/mishka-s-bantikom-2.webp', stock:true, hit:true,
    note:'Крупный медведь — самостоятельный подарок, а не дополнение.' },
  { id:'mishka-s-bantikom-3', name:'Мишка с бантиком, средний', price:37, cat:'podarki', sub:'igrushki', occ:'vnimanie', img:'images/products/mishka-s-bantikom-3.webp', stock:true,
